package xsupermu.android.qibla
...
import xsupermu.android.qibla.sensor.Domain
import xsupermu.android.qibla.sensor.LocationFinder
...
/**
 * Creates an Activity that hosts the Qibla fragment
 */
class MainActivity : AppCompatActivity() {
	...
	private fun getQiblaLocation() {
		...
		if (locationFinder!!.canGetLocation()) {
			...
			result = ((toDegrees(atan2(y, x)) + 360) % 360)
